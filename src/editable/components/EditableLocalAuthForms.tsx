...
const inputClass = 'h-[3.25rem] rounded-full border border-black/10 bg-white px-5 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-full bg-[var(--slot4-dark-bg)] px-6 text-xs font-black text-white transition hover:bg-[var(--slot4-accent)] disabled:opacity-60'
